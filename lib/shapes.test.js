...
describe("Star", () => {
  test("should create star element", () => {
    const correctSvg =
      '<polygon points="50 160 55 180 70 180 60 190 65 205 50 195 35 205 40 190 30 180 45 180" fill="yellow" />';
    const square = new Square();
  ...
  test("should accept shape color", () => {
    const correctSvg =
      '<polygon points="50 160 55 180 70 180 60 190 65 205 50 195 35 205 40 190 30 180 45 180" fill="turquoise" />';
    const square = new Square();
